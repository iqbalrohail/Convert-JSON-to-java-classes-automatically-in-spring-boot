...
public class TeamBScore {
    ...
    public String toString() {
        ...
        sb.append(TeamBScore.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("score");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TeamBScore) == false) {
            return false;
        }
        TeamBScore rhs = ((TeamBScore) other);
